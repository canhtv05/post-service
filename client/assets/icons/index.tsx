...
export const HomeFillIcon = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
      <g>
        <path
...
export const SearchFillIcon = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
      <g>
        <path
...
export const BellFillIcon = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
      <g>
        <path
...
export const MailFillIcon = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
      <g>
        <path
...
export const UserFillIcon = ({ className }: { className?: string }) => {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" className={className}>
      <g>
        <path
